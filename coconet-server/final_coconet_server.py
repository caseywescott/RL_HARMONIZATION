#!/usr/bin/env python3
"""
Final Coconet Harmonization Server

This server uses a simpler approach to load the Coconet model.
"""
...
app = FastAPI(title="Final Coconet Harmonization API")

# Model configuration
COCONET_MODEL_DIR = "/app/coconet-64layers-128filters"

class FinalCoconetHarmonizer:
    ...
    def load_model(self):
        """Load the Coconet model with timeout"""
        try:
            ...
            try:
                ...
                with self.graph.as_default():
                    ...
                    # Use a simpler approach to parse the graph
                    ...
                    text_format.Parse(graph_content, graph_def)
                    
                    print(f"   Graph parsed successfully")
                    
                    # Import the graph
                    tf.import_graph_def(graph_def, name='')
                    print(f"   Graph imported successfully")
...
async def startup_event():
    global harmonizer
    try:
        harmonizer = FinalCoconetHarmonizer(COCONET_MODEL_DIR)
...
def read_root():
    ...
    <html>
        <head>
            <title>Final Coconet Harmonization API</title>
            <style>
        ...
        <body>
            <h1>🎵 Final Coconet Harmonization API</h1>
            <p>This API uses a <strong>final working Coconet implementation</strong> for harmonization.</p>
            
            <h2>Key Features:</h2>
            <ul>
                <li><span class="success">✅ Timeout-protected model loading</span></li>
            ...
            <ul>
                ...
                <li><strong>POST /harmonize</strong> - Harmonize using final Coconet</li>
            </ul>
...
async def get_status():
    ...
    return {
        ...
        "harmonization_method": "Final Coconet Direct Model"
    }
...
async def harmonize_melody(
    ...
    """
    Harmonize a melody using final Coconet
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            print("🤖 Running final Coconet harmonization...")
            ...
            return FileResponse(
                ...
                filename=f"final_coconet_harmonization_{temperature}.mid"
            )
