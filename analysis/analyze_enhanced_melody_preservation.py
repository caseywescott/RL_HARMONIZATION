...
def analyze_enhanced_melody_preservation():
    ...
    files_to_analyze = [
        ...
        ("../midi_files/enhanced_melody_preserved_v1.mid", "ENHANCED V1 (temp=0.7, strength=2.5, reduction=0.5)"),
        ("../midi_files/enhanced_melody_preserved_v2.mid", "ENHANCED V2 (temp=0.5, strength=3.0, reduction=0.4)")
    ]
