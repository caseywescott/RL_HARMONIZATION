...
def analyze_corrected_harmonization():
    """Analyze the corrected harmonization to check if melody is preserved"""
    print("🎼 CORRECTED HARMONIZATION ANALYSIS")
    print("=" * 60)
    ...
    try:
        ...
        # Analyze corrected harmonizations
        harmonization_files = [
            "../midi_files/realms_corrected_harmonization.mid",
            "../midi_files/realms_corrected_harmonization_v2.mid"
        ]
        ...
        print(f"\n📋 SUMMARY:")
        print("=" * 60)
        print(f"Corrected harmonizations should preserve the original melody.")
        print(f"If melody is found in instrument 0, the masking fix is working.")
        print(f"Current results suggest the masking approach is still not working correctly.")
...
if __name__ == "__main__":
    analyze_corrected_harmonization() 