...
def compare_harmonizations():
    ...
    print("🎵 HARMONIZATION COMPARISON")
    print("=" * 60)
    ...
    files = [
        ...
        ("../midi_files/test_docker_coconet.mid", "Docker Coconet Output"),
        ("../midi_files/pure_coconet_harmonization.mid", "Previous Docker Output")
    ]
