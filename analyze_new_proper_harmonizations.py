...
def analyze_new_proper_harmonizations():
    ...
    try:
        ...
        harmonization_files = [
            ("realms_proper_harmonization_v2.mid", 0.8),
            ("realms_proper_harmonization_v3.mid", 1.2),
            ("realms_proper_harmonization_v4.mid", 0.6),
            ("realms_proper_harmonization_v5.mid", 0.4),
            ("realms_proper_harmonization_v6.mid", 1.5)
        ]
