...
def analyze_enhanced_harmonizations():
    ...
    files_to_analyze = [
        ...
        ("realms_fixed_harmonization_v1.mid", "ORIGINAL COCONET V1"),
        ("melody_enhanced_v1.mid", "ENHANCED V1 (2.5x melody, 0.5x harmony)"),
        ("realms_fixed_harmonization_v2.mid", "ORIGINAL COCONET V2"),
        ("melody_enhanced_v2.mid", "ENHANCED V2 (3.0x melody, 0.4x harmony)"),
        ("realms_fixed_harmonization_v3.mid", "ORIGINAL COCONET V3"),
        ("melody_enhanced_v3.mid", "ENHANCED V3 (2.0x melody, 0.6x harmony)")
    ]
